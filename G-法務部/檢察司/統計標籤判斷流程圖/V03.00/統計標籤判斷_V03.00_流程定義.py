...
執行: python 統計標籤判斷_V03.00_流程定義.py [輸出資料夾]
"""
import sys, os
...
def build_pretrial():
    ...
    p.assoc("a_d1", "a_3"); p.assoc("a_5", "a_d2"); p.assoc("a_gw", "a_n1")
...
def build_execution():
    ...
    p.assoc("b_d1", "b_1"); p.assoc("b_3", "b_d2"); p.assoc("b_gw", "b_n1")
...
if __name__ == "__main__":
    ...
    emit_multi([build_pretrial(), build_execution()], "統計標籤判斷",
               outdir, version="V03.00", src=__file__,
               change="改多頁專案:頁1偵查類(承V02.01)+新增頁2執行類(每日排程撈裁判書)",
