# -*- coding: utf-8 -*-
"""統計標籤判斷工作流程圖(多頁):頁1 偵查類、頁2 執行類、頁3 偵查類(含介接說明)
執行: python 統計標籤判斷_V05.00_流程定義.py [輸出資料夾]
"""
import sys, os
...
if __name__ == "__main__":
    ...
    emit_multi([build_pretrial(), build_execution(), build_pretrial_notes()], "統計標籤判斷",
               outdir, version="V05.00", src=__file__,
               change="新增頁3:偵查類介接說明(觸發呼叫/書類資訊傳遞、SFTP拋轉與讀取)",
