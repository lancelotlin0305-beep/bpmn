...
執行: python 統計標籤判斷_偵查類_工作流程圖_V02.01_流程定義.py [輸出資料夾]
"""
import sys, os
...
def build():
    ...
    p.add("a8",  "task",    "點選「AI引用」按鈕", 1, kind="user")
...
if __name__ == "__main__":
    ...
    emit(build(), outdir, fmt="drawio", src=__file__,
         change="更名AI應用→AI引用;註解改收框內不溢出泳道", change_kind="文字", change_source="流程說明")
