...
執行: python 統計標籤判斷_偵查類_工作流程圖_V01.00_流程定義.py [輸出資料夾]
"""
import sys, os
...
if __name__ == "__main__":
    ...
    emit(build(), outdir, fmt="drawio", src=__file__,
         change="初版產出(偵查類;執行類待確認後另行繪製)", change_kind="初版", change_source="流程說明")
