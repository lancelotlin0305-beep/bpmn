...
V07.03:分區「漢書系統」更名為「書類生成系統-漢書系統」(任務文字維持簡短寫法)。
執行: python 不起訴書生成工作流程圖_V07.03_流程定義.py [輸出資料夾]
"""
import sys, os
sys.path.insert(0, r"D:\claude-skills-marketplace\plugins\bpmn-flow-builder\skills\bpmn-flow-builder\scripts")
...
if __name__ == "__main__":
    ...
    emit_multi([build("a_", "不起訴書生成工作流程圖", "檢察官不起訴書生成工作流程圖"),
                build("b_", "不起訴書生成工作流程圖_介接說明", "檢察官不起訴書生成工作流程圖(含介接說明)",
                      with_notes=True)],
               "不起訴書生成工作流程圖", outdir, version="V07.03", src=__file__,
               change="分區「漢書系統」更名為「書類生成系統-漢書系統」(任務文字維持簡短寫法)",
