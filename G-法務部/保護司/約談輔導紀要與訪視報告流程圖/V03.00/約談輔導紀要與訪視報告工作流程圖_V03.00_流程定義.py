...
def paint_red(ai, vdir):
    ...
    dpath = os.path.join(vdir, PROJECT + "_" + VERSION + ".drawio")
    d = _read(dpath)
    n = 0
    def repl(m):
        nonlocal n
    ...
    targets = [
        (os.path.join(vdir, ai.pid + "_" + VERSION + ".svg"), ""),
        (os.path.join(vdir, PROJECT + "_" + VERSION + "_檢視器.html"), "p0_"),
    ]
...
if __name__ == "__main__":
    ...
    paint_red(ai, os.path.join(outdir, VERSION))
